...
// Inserts an integer at a given position
void IntListInsertAt(struct IntListNode *before, struct IntListNode *after, int v);
...
void IntListInsertInOrder(IntList L, int v)
{
	...
	// 	printf("running!!!");
	// /*
	//  * Iterate over nodes, until we find one > v
	//  * Then insert before node
	//  */
